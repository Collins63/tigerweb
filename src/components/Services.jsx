...
import { curve1, lines } from '../assets'
...
import { SwipeCarousel } from './Design/SwipeCarousel'
    ...
    <div className=''>
        <div className='-mt-5'>
            <div className='h-15 rounded-2xl border-blue-400  items-center shadow-[0_4px_20px_rgba(96,165,250,0.4)] translate-x-1/2 bg-white w-1/2'>
                <p className='text-center pt-5 text-2xl font-bold bg-gradient-to-br from-blue-800 to-white bg-clip-text leading-tight text-[#041E42]'>Services</p>
            </div>
            <div className="">
                <img src={curve1} width={320} height={100} alt="Curve 1" className='filter rotate-90 invert-36 sepia-50 saturate-700 hue-rotate-200' />
            </div>         
        </div>
        <Heading
          tag="We Provide The Following Services...Globally!!"
         />
        <SwipeCarousel />

        

        {/* <div className='bg-white shadow-2xl w-full mt-10 rounded-2xl h-100'>
